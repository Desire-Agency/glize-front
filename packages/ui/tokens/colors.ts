...
export const lightColors = {
  ...
  gradientCardHeaderWhite: 'linear-gradient(166.77deg, #EBF0F4 0%, #EBF0F4 100%)',
...
export const darkColors = {
  ...
  textGray: '#7F7787',
  disabled: '#524B63',
  gradientBubblegum: 'linear-gradient(139.73deg, #030122 0%, #030122 100%)',
